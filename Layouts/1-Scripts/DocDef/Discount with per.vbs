...
Dim discount, items, price, item_price, new_disc

discount = Replace(me.Field("allowancecharge").Text,"-","")
items = me.Field("items_ordered").Text
price = Replace(me.Field("item_price").Text,".","")
item_price = Replace(me.Field("item_price").Text,",",".")

percentage = discount/100 '0.50
Round(new_disc,2) = items * item_price * percentage
